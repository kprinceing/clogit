program clogit_sch_v21_mata
	...
	*/
	...
	quietly{ 
        ...
        */
        gen double `term1'   = (1-`exp_alpha'*indicator_1)*`p_ca'
        // noisily sum `term1' if `y' == 1
        /*
        ...
        */
        ...
        mata: term2_2 = rank_2("`e_xb'", "`sum_e_xb_c'","id","clg_id","clg_unavailable","choice")
        getmata `term2_2' =term2_2
        mata: term2_3 = rank_3("`e_xb'", "`sum_e_xb_c'","id","clg_id","clg_unavailable","choice")
        getmata `term2_3' =term2_3

        // noisily sum `term2_1' `term2_2' `term2_3' if `y' == 1


        noisily display `exp_alpha'
        gen double `lnfj'  = ln(`term1' + `exp_alpha'*indicator_1*(`term2_1'+ `term2_2'+ `term2_3'))
